...
//       // after setMsg("Login successful!");
//     setTimeout(() => {
//       // read current location.state if your guards passed it via Navigate state={{ from: location }}
//       const adminEmail = "growlifesupremo2025@gmail.com";
//       const userEmail = (user.email || "").toLowerCase();

//       // safely read "from" (requires useLocation in the component)
//       const from =
//         (location && (location as any).state && (location as any).state.from?.pathname) ||
//         "/dashboard";

//       // if the admin email logs in, force /admin; otherwise go to "from" unless it's /admin
//       const destination =
