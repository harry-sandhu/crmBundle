            ...
            {loading ? (
              ...
              users.map((u) => (
                <tr key={u._id} className="border-t">
                  ...
                  <td className="px-3 py-2 text-right">
                    <button onClick={() => openPanel(u)} className="text-green-700 underline mr-3">
                      View
                    </button>
                    <button onClick={() => handleDelete(u._id)} className="text-red-600 underline">
                      Delete
                    </button>
                  </td>
                </tr>
      ...
      {panelOpen && selected && (
        <div className="fixed inset-0 bg-black/30 flex justify-end z-40">
          <div className="w-full max-w-md h-full bg-white shadow-xl p-5 overflow-y-auto">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-bold">Edit Profile</h3>
              <button onClick={closePanel} className="text-2xl leading-none">
                &times;
              </button>
            </div>
